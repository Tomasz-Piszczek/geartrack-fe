...
const PackagingTab: React.FC = () => {
  ...
  const handleMarginPercentChange = (value: number) => {
    ...
    dispatch({ type: 'SET_TAB_FIELD', tab: 'packaging', field: 'marginPercent', value });
  };

  const handleMarginPlnChange = (value: number) => {
    const marginPercent = data.price > 0 ? (value / data.price) * 100 : 0;
    dispatch({ type: 'SET_TAB_FIELD', tab: 'packaging', field: 'marginPln', value });
    dispatch({ type: 'SET_TAB_FIELD', tab: 'packaging', field: 'marginPercent', value: marginPercent });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-t pt-4">
        <h4 className="text-lg font-medium text-white mb-4">Koszt Pakowania</h4>
